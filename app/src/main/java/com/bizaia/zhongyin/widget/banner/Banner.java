package com.bizaia.zhongyin.widget.banner;
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        switch (event.getActionMasked()) {
            case MotionEvent.ACTION_DOWN:
                fistPoint.set(event.getX(), event.getY());
                if (onTouchCallBack != null) {
                    onTouchCallBack.actionDown();
                }
                break;
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (Math.sqrt(
                        (lastPoint.x - fistPoint.x) * (lastPoint.x - fistPoint.x) +
                                (lastPoint.y - fistPoint.y) * (lastPoint.y - fistPoint.y)
                ) > ViewConfiguration.getEdgeSlop()) {
                    if (Math.abs(lastPoint.y - fistPoint.y) > Math.abs(lastPoint.x - fistPoint.x)) {
                        if (onTouchCallBack != null) {
                            onTouchCallBack.actionMoveCancel();
                        }
                    } else {
                        if (onTouchCallBack != null) {
                            onTouchCallBack.actionMove();
                        }
                    }
                }
                break;
